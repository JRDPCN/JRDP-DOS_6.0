...
rem Version 6.0
rem Made by JRDP Team
rem Released under the BullShit License 2.0
rem Send any bugs, ideas or comments to jrdpteam@proton.me
...
ABOUT:
  $T = "About"
  $5 = "Calculator, version 6.0"
  $6 = "An advanced calculator application"
  $7 = "Released under the BullShit License 2.0"
  $8 = "Written in JRDP-DOS BASIC"
  $9 = "Thanks to the JRDP-DOS 6.0 developers"
  GOSUB MESBOX

  $5 = "Uses the MB++ Library, version 3.0"
  $6 = "A great TUI library"
  $7 = "Created by JRDP Team"
  $8 = "Mail: jrdpteam@proton.me"
